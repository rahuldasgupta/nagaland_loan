...
class ViewExamDetails extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      userData: [],
  ...
  checkApplied = async(userID, examID, token) => {
    ...
    .then((responseJson) => {
        if(responseJson.Status == "Record Exist"){
            this.setState({
                roll_no: responseJson.roll_no,
                transactionToken: responseJson.token,
  ...
  navigateTo = () => {
    let appliedArr = this.state.appliedArr;
    this.props.history.push("/confirmation", { appliedArr: appliedArr });
  }
  render() {
    const { fontSize } = this.props;
    ...
    return (
      <div>
        <Helmet>
            <html lang="en" />  
            <meta charSet="utf-8" />
            <title>NSSB: Nagaland Staff Selection Board - Registration Portal | View Examination Details</title>
              ...
              <div style={{padding: 5}}>
                ...
                <center>
                  ...
                  <Row>
                    ...
                    <Col md={6} sm={6} xs={6}>
                        <div className="login_button" onClick={this.navigateTo}>
            ...
            <ModalBody>
              <div style={{padding: 5}}>
                ...
                <center>
                  ...
                  <div className="changePosts_button" onClick={()=> this.props.history.push("/change-posts", { roll_no: this.state.roll_no, transactionToken: this.state.transactionToken })}>
                    <p className="login_signup_ques_text_white">Change Posts Applied</p>
                  </div>
                </center>
              </div>
            </ModalBody>
            ...
            <>
                {
                    ...
                    <>
                        <p className="login_header_text">{this.state.postsArr[0].exam_name}</p>
...
export default withRouter(ViewExamDetails);